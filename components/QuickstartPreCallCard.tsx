  ...
  return (
    ...
    >
      <h1 className="text-[28px] font-medium leading-[1.2] text-white">
        EchoSphere Interview Panel
      </h1>
      <p className="mt-[14px] text-sm font-medium leading-6 text-muted-foreground">
        A live, interruptible AI interview. You will speak with an AI panel,
        not a human interviewer.
      </p>
      <p
        className="mt-4 rounded-lg border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-xs font-medium leading-5 text-amber-100"
        role="status"
      >
        AI disclosure: this session is fully AI-generated. Speak naturally; you
